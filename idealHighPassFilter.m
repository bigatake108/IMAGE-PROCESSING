function [ hpimg ] = my_idealHighPassFilter( img, minFrequency )

hpimg = zeros(size(img));
...
euclid = sqrt(K.^2 + I.^2);
% Creating a filter-mask in dependence of the given min-frequency.
mask = double(euclid > minFrequency);
